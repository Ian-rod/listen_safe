                ...
                borderRadius: BorderRadius.only(
                 ...
                 child: Image.asset("assets/imageAssets/film_select.jpg", fit: BoxFit.
                  fill,)),
                          ...
                          AnimatedTextKit(
              animatedTexts:[
              ColorizeAnimatedText(AppConstants.localizations.filmSafe, textStyle: TextStyle(fontSize: 35,fontStyle: FontStyle.italic), colors: [AppConstants.secondary,AppConstants.accent])
            ] ),
            ],
          ),
               Padding(
